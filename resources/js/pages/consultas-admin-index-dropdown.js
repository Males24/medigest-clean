...
// Requer: window.mostrarModalConsulta, window.confirmarCancelamento
...
function openDropdown(trigger) {
  ...
  if (canCancel && cancelUrl) {
    ...
    items.push({
      ...
      danger: true,
      onClick: () => window.confirmarCancelamento?.({
        action: cancelUrl,
        csrf: document.querySelector('meta[name="csrf-token"]')?.content || '',
        mensagem: t('modals.cancel.question','Are you sure you want to cancel this consultation?'),
      }),
    });
  }
