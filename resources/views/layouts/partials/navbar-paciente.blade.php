...
<nav id="patient-nav"
     ...
     class="relative sticky top-[var(--header-h,56px)] z-40 bg-white border-b border-gray-200 overflow-visible">
  <div class="relative max-w-[1430px] mx-auto px-4 sm:px-6 lg:px-8">
    <div class="h-12 flex items-center justify-center">

      {{-- Agrupador dos links principais (não usar position aqui!) --}}
      <div id="servicos-wrap" class="flex items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          class="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-zinc-900 hover:text-home-medigest
                 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/40 rounded-lg"
        >
          <span>Serviços</span>
      ...
      {{-- MEGA MENU (posicionado relativamente ao NAV e centrado pelo container) --}}
      <div
        id="servicos-mega"
        role="dialog"
        aria-modal="false"
        ...
        class="hidden absolute top-full left-1/2 -translate-x-1/2
               w-[min(96vw,1200px)] z-[90] rounded-2xl bg-white
               ring-1 ring-gray-200 shadow-xl overflow-hidden
               md:max-h-[calc(100vh-160px)] md:overflow-auto"
      >
          ...
          <aside class="col-span-12 md:col-span-3 bg-gradient-to-b from-gray-50 to-gray-100 border-r border-gray-200">
            <div class="p-3 sm:p-4">
              ...
              <div class="space-y-2" role="tablist" aria-orientation="vertical">
                <button class="tab-btn w-full text-left rounded-lg px-3 py-2 text-sm border border-transparent
                               bg-emerald-50 text-emerald-700 focus:outline-none"
              ...
              <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2">
                  ...
                  <p class="text-sm text-gray-700 leading-relaxed">
                    A <strong>consulta externa</strong> permite-lhe agendar atendimento presencial ou por vídeo com
                    médicos da nossa rede. Escolha a modalidade mais conveniente, veja horários disponíveis e finalize
                    a marcação em poucos passos.
                  </p>
